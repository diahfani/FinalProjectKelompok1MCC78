...
namespace API.Migrations
{
    ...
    [Migration("20230624051330_FixingRelationshipAccountRole")]
    partial class FixingRelationshipAccountRole
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 6, 24, 12, 13, 30, 504, DateTimeKind.Local).AddTicks(4788),
                            ModifiedDate = new DateTime(2023, 6, 24, 12, 13, 30, 504, DateTimeKind.Local).AddTicks(4796),
                            Name = "employee"
                        },
                        new
                        {
                            Guid = new Guid("f0ed952a-0321-4193-3653-08db73d30b74"),
                            CreatedDate = new DateTime(2023, 6, 24, 12, 13, 30, 504, DateTimeKind.Local).AddTicks(4798),
                            ModifiedDate = new DateTime(2023, 6, 24, 12, 13, 30, 504, DateTimeKind.Local).AddTicks(4799),
                            Name = "manager"
                        });
                });
