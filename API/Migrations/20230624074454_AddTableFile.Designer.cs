...
namespace API.Migrations
{
    ...
    [Migration("20230624074454_AddTableFile")]
            ...
            modelBuilder.Entity("API.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 6, 24, 14, 44, 54, 394, DateTimeKind.Local).AddTicks(4104),
                            ModifiedDate = new DateTime(2023, 6, 24, 14, 44, 54, 394, DateTimeKind.Local).AddTicks(4113),
                            Name = "employee"
                        },
                        new
                        {
                            Guid = new Guid("f0ed952a-0321-4193-3653-08db73d30b74"),
                            CreatedDate = new DateTime(2023, 6, 24, 14, 44, 54, 394, DateTimeKind.Local).AddTicks(4116),
                            ModifiedDate = new DateTime(2023, 6, 24, 14, 44, 54, 394, DateTimeKind.Local).AddTicks(4116),
                            Name = "manager"
                        });
                });
            ...
            modelBuilder.Entity("API.Model.File", b =>
                {
                    b.HasOne("API.Model.Report", "Report")
                        .WithOne("File")
                        .HasForeignKey("API.Model.File", "Guid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
