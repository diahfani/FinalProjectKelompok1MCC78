...
namespace API.Migrations
{
    ...
    [Migration("20230624044332_FixingRelationshipTask")]
    partial class FixingRelationshipTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 6, 24, 11, 43, 32, 109, DateTimeKind.Local).AddTicks(1963),
                            ModifiedDate = new DateTime(2023, 6, 24, 11, 43, 32, 109, DateTimeKind.Local).AddTicks(1974),
                            Name = "employee"
                        },
                        new
                        {
                            Guid = new Guid("f0ed952a-0321-4193-3653-08db73d30b74"),
                            CreatedDate = new DateTime(2023, 6, 24, 11, 43, 32, 109, DateTimeKind.Local).AddTicks(1976),
                            ModifiedDate = new DateTime(2023, 6, 24, 11, 43, 32, 109, DateTimeKind.Local).AddTicks(1976),
                            Name = "manager"
                        });
                });
